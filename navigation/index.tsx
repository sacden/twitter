    ...
    >
      <BottomTab.Screen
        ...
        options={({ navigation }: RootTabScreenProps<"Home">) => ({
          ...
          headerRight: () => <MaterialCommunityIcons name={"star-four-points-outline"} size={30} color={Colors.light.tint} style={{ marginRight: 15 }} />,
          headerLeft: () => {
            return <ProfilePicture size={40} image={"https://cdn.pixabay.com/photo/2015/01/08/18/29/entrepreneur-593358_1280.jpg"} />;
          },
        })}
      />
      <BottomTab.Screen
